...
public class InventorylistOfflineActivity extends AppCompatActivity implements MakeWebRequest.OnResponseSuccess {
    ...
    private List<m_inventory_items> line_item_list;
        ...
        if (cursorCount == 0) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    String MfgCode=cursor.getString(10);
                    String MfgName=cursor.getString(11);
                    String Mrp=cursor.getString(6);
                    String Rate=cursor.getString(7);
                    String HalfScheme=cursor.getString(14);
                    String PercentScheme=cursor.getString(15);
                    String LegendName=cursor.getString(16);
                    String LegendColor=cursor.getString(17);
                    if(Mrp.equals(null) || Mrp.equals("null") || Mrp.equals("")){
                        Mrp = "0";
                    }
                    if(Rate.equals(null)|| Rate.equals("null") || Rate.equals("")){
                        Rate="0";
                    }
                    if(stock.equals(null) || stock.equals("null") || stock.equals(""))
                    {
                        stock ="0";
                    } if(scheme.equals(null) || scheme.equals("null")) {
                        scheme ="";
                    }
//                    stockistProducts.setLegendName(cursor.getString(16));
//                    stockistProducts.setLegendColor(cursor.getString(17));
                    //m_inventory_items line_items=new m_inventory_items(Float.parseFloat(Mrp),Float.parseFloat(Rate),MfgCode,MfgName);
                    m_inventory_items line_items=new m_inventory_items(Float.parseFloat(Mrp),Float.parseFloat(Rate),MfgCode,MfgName,HalfScheme,PercentScheme);
                    line_item_list = new ArrayList<m_inventory_items>();
                    line_item_list.add(line_items);
                    m_inventory m_inventory = new m_inventory(itemCode, itemName, stock, productId, packSize, doseForm, scheme,LegendName,LegendColor);
                    m_inventory.setline_items(line_item_list);
        ...
        dialogview.findViewById(R.id.btn_filter).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!edt_search_word.getText().toString().isEmpty()) {
                    ...
                    OGtoast.OGtoast("Please enter a name to filter", InventorylistOfflineActivity.this);
    ...
    void fill_exapndable(List<m_inventory> filteredModelList, String legend_data) {
        if (filteredModelList != null) {
            ...
            if (filteredModelList.size() > 0) {
                empty_view.setVisibility(View.GONE);
                adapter = new Exad_inventoryItems(filteredModelList, InventorylistOfflineActivity.this, call_plan_customer_id, orderAmount, legend_data);
