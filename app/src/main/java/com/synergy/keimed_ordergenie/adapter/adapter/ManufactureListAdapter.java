...
/*public class ManufactureListAdapter {
    public ManufactureListAdapter(Context applicationContext, List<ChemistInventorymodel> postss, Products_Catlog_Search products_catlog_search) {
    }
}*/

public class ManufactureListAdapter extends RecyclerView.Adapter<ManufactureListAdapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView P_itemname, tx_psizee,tx_pmanufaturename,tx_prate,txt_mrp;
    ...
    public ManufactureListAdapter(Context context, List<ChemistInventorymodel> contactList, ContactsAdapterListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
      ...
      /*  holder.P_itemname.setText((contact.getIM() == null) ? "NA" : contact.getIM());
        holder.tx_psizee.setText((contact.getPZ() == null) ? "NA" : contact.getPZ());
        holder.tx_pmanufaturename.setText((contact.getMfgN() == null) ? "NA" : contact.getMfgN());
        holder.tx_prate.setText((contact.getRate() == null) ? "NA" : contact.getRate());
        holder.txt_mrp.setText((contact.getMrp() == null) ? "NA" : contact.getMrp());*/

        if(contact.get_lm()== null){
            ...
            protected FilterResults performFiltering(CharSequence charSequence)
            {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ChemistInventorymodel row : contactList)
                    {
                        ...
                        if ((row.get_mn() != null && row.get_mn().replace("-", "").replace(" ", "").replace("(", "").replace(")", "")
                        ...
                        )&&(row.get_mn() != null && row.get_mn().replace("-", "").replace(" ", "").replace("(", "").replace(")", "")
                                .replace("/", "").replace("*", "").replace(":", "").replace("_", "").replace(".", "").replace("'", "").replace("`", "").replace("~", "").replace("^", "").replace("+", "").replace(",", "").replace("<","").replace(">","").toLowerCase()
