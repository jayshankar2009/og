 ...
 */
public class ad_offersliding extends PagerAdapter {
    Context _mContext;
    ...
    public ad_offersliding(Context _mContext, List<m_offerlist> _datalist) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = inflater.inflate(R.layout.viewpager_ofeer_sliding, container, false);
