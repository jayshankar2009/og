...
public class SelectedpaymentAdapter extends RecyclerView.Adapter<SelectedpaymentAdapter.MyViewHolder> {
    ...
    public SelectedpaymentAdapter(Context context, List<m_pendingbills> paymentsList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(mm_pendingbills.getInvoicedate()!=null&&mm_pendingbills.getInvoicedate().length()>0){
            holder.date_text.setText(parseDateToddMMyyyy(mm_pendingbills.getInvoicedate()));
        }else{
        ...
        if (mm_pendingbills.getInvoicedate() != null) {
           ...
           // SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
            ...
            try {
                ...
                Log.d("Date11","Date:"+mm_pendingbills.getInvoicedate());
