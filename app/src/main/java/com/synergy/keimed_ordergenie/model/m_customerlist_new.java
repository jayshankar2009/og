 ...
 */
public class m_customerlist_new extends BaseObservable {
	...
	public int getDLExpInd() {
		return DLExpInd;
	}

	public void setDLExpInd(int DLExpInd) {
		this.DLExpInd = DLExpInd;
	}

	int DLExpInd;
	/*public Integer getDLExpiryInd() {
		return DLExpiryInd;
	}

	public void setDLExpiryInd(Integer DLExpiryInd) {
		this.DLExpiryInd = DLExpiryInd;
	}
...
*/
	...
	public m_customerlist_new(String CustomerName) {
		this.CustomerName = CustomerName;
	}

	public m_customerlist_new(String CustomerName, String Location,
	...
	public m_customerlist_new newInstance(){
		m_customerlist_new o_customerlist = new m_customerlist_new("");
