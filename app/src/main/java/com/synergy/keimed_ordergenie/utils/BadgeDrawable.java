...
public class BadgeDrawable extends Drawable {
	...
	public BadgeDrawable(Context paramContext) {
		this.mTextSize = paramContext.getResources().getDimension(R.dimen.cart_fontsize);
		this.mBadgePaint = new Paint();
		this.mBadgePaint.setColor(paramContext.getResources().getColor(R.color.colorPrimary));
		//this.mBadgePaint.setColor(R.color.welcome_text_color);
