...
/** 
 * DAO for table "CHEMIST_ORDER".
*/
public class ChemistOrderDao extends AbstractDao<ChemistOrder, Long> {

    public static final String TABLENAME = "CHEMIST_ORDER";

    /**
     * Properties of entity ChemistOrder.<br/>
    ...
    public ChemistOrderDao(DaoConfig config) {
        super(config);
    }
    
    public ChemistOrderDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHEMIST_ORDER\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHEMIST_ORDER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ChemistOrder entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ChemistOrder entity) {
        stmt.clearBindings();
    ...
    @Override
    public ChemistOrder readEntity(Cursor cursor, int offset) {
        ChemistOrder entity = new ChemistOrder( //
    ...
    @Override
    public void readEntity(Cursor cursor, ChemistOrder entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ChemistOrder entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ChemistOrder entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ChemistOrder entity) {
